...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    func insertNewObject(_ sender: Any) {
        ...
        let searchAction = UIAlertAction(title: "Search", style: .default, handler: {
            ...
            action in let isbnCode = inputBoxMessage.textFields!.first!.text!
            let book = self.getBookData(isbnCode: isbnCode)
            //let activityIndicator = UIActivityIndicatorView(activityIndicatorStyle: .whiteLarge, color: .gray,  placeInTheCenterOf: self.tableView)
